...
## 👥 Team Contributions
- **JudeCJz** (Team Lead): Core Concept, CameraX Architecture, Sensor Fusion Mathematics, Puzzle Shutter Logic, Roast Engine & Certificate Canvas.
- **Aswal S Ajay**: UI/UX Refinements, "Baby Mode" HUD & Reticle, Vector Icons, In-App Gallery & Usability Testing.
